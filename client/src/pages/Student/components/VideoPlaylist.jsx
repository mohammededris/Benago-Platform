  ...
  return (
    <div className="playlist-card">
      ...
      <div className="playlist-header">
        <h3 className="playlist-title">Course Lectures</h3>
        <p className="playlist-subtitle">{videos.length} videos</p>
      </div>
      ...
      >
        <span>Course Lectures · {videos.length} videos</span>
        <svg
          width="18"
          height="18"
          viewBox="0 0 24 24"
                ...
                >
                  ...
                  <div className="video-item-info">
                    ...
                    <div className="video-item-meta">
                      <span className="video-badge">Lecture {video.order || idx + 1}</span>
                      {video.duration && (
